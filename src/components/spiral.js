...
function init() {
  ...
  f1.add(badTVParams, "distortion", 0.1, 20)
    .step(0.1)
    .listen()
    .name("Thick Distort")
    .onChange(onParamsChange);
  f1.add(badTVParams, "distortion2", 0.1, 20)
    .step(0.1)
    .listen()
    .name("Fine Distort")
    .onChange(onParamsChange);
  f1.add(badTVParams, "speed", 0.0, 1.0)
    .step(0.01)
    .listen()
    .name("Distort Speed")
    .onChange(onParamsChange);
  f1.add(badTVParams, "rollSpeed", 0.0, 1.0)
    .step(0.01)
    .listen()
    .name("Roll Speed")
    .onChange(onParamsChange);
  ...
  f4.add(staticParams, "amount", 0.0, 1.0)
    .step(0.01)
    .listen()
    .onChange(onParamsChange);
