...
export const Tv = styled.div`
  ...
  &:after {
    ...
    -moz-animation: ${screenEffect} 800ms infinite linear;
    -o-animation: ${screenEffect} 800ms infinite linear;
    -webkit-animation: ${screenEffect} 800ms infinite linear;
    animation: ${screenEffect} 800ms infinite linear;
  }
...
export const Button_Channel = styled.button`
  position: relative;
  width: 70px;
  height: 20px;
  top: 10px;
