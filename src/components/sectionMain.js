    ...
    <SectionContainer style={{ backgroundColor: props.background }}>
      ...
      <SectionContents style={{ marginTop: "30px" }}>
        ...
        <SectionMainDescription style={{ marginTop: "16px" }}>
          Hey there, I'm <span style={{ fontWeight: 900 }}>Justin Kaseman</span>
        ...
        <SocialLinks>
          <Social>
            <a href="https://github.com/Jkasem" title="GitHub">
          ...
          <Social>
            <a
              href="https://www.instagram.com/just.in.kase.man/"
              title="Instagram"
            >
              <svg viewBox="0 0 512 512">
          ...
          <Social>
            <a
              href="https://www.linkedin.com/in/justin-kaseman/"
              title="LinkedIn"
            >
              <svg viewBox="0 0 512 512">
          ...
          <Social>
            <a href="mailto:justinkaseman@live.com?Subject=Hello" title="Email">
              <svg viewBox="0 0 512 512">
